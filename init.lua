...
-- This shows yellow color for linenumbers
vim.cmd 'highlight CursorLineNr guifg=#FFF033 guibg=NONE'
vim.cmd 'highlight LineNrAbove guifg=#FFF033 guibg=NONE'
vim.cmd 'highlight LineNrBelow guifg=#FFF033 guibg=NONE'

-- NetrwLineNumbers
vim.api.nvim_create_augroup('NetrwLineNumbers', { clear = true })
vim.api.nvim_create_autocmd('FileType', {
  group = 'NetrwLineNumbers',
  pattern = 'netrw',
